...
var versionCmd = &cobra.Command{
	Use:     "version",
	Aliases: []string{"v"},
	Short:   "Prints the version of dms your project is using.",
	Long: `Prints the version of dms your project is using. Must be called from
within a dms project directory.`,
	Example: `$ dms version
> dms v0.8.2
(or)
$ dms version --cli

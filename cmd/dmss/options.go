...
var ponzuRepo = []string{"github.com", "agreyfox", "eshop"}
...
func vendorCorePackages(path string) error {
	fmt.Println("vender Package process...")
	vendorPath := filepath.Join(path, "cmd", "dmss", "vendor", "github.com", "agreyfox", "eshop")

...
current project's addons directory. Must be called from within a Dms project directory. Addon
needs to imported in at least one content item for it to be included in the Dms server build.`,
	Example: `$ Dms add github.com/bosssauce/fbscheduler`,
...
func addError(err error) error {
	return errors.New("Dms add failed. " + "\n" + err.Error())
}

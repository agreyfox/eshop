...
func setFieldView(field *generateField, viewType string) error {
	...
	tmplDir := filepath.Join(pwd, "cmd", "templates")
...
func generateContentType(args []string) error {
	...
	tmplPath := filepath.Join(pwd, "cmd", "templates", "gen-content.tmpl")
...
var generateCmd = &cobra.Command{
	...
	Short:   "generate boilerplate code for various eshop components",
	Long: `Generate boilerplate code for various eshop components, such as 'content'.
...
generate commands return nothing.`,
	Example: `$ eshop gen content review title:"string" body:"string" rating:"int" tags:"[]string"`,
}

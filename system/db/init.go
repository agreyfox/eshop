...
var (
	store            *bolt.DB
	DB__config       = "eshop__config"
	DB__users        = "eshop__users"
	DB__uploads      = "eshop__uploads"
	DB__contentIndex = "eshop__contentIndex"
	DB__addons       = "eshop__addons"

	buckets = []string{
		"eshop__config", "eshop__users",
		"eshop__addons", "eshop__uploads",
		"eshop__contentIndex",
	}
